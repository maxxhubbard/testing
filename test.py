...
with SB(uc=True, test=True) as sb:
    ...
    if not testtw() and not testkick():
        ...
        sb.uc_click("ytd-app::shadow ytd-page-manager::shadow ytd-browse::shadow ytd-two-column-browse-results-renderer::shadow ytd-rich-grid-renderer::shadow div#contents ytd-rich-item-renderer:nth-child(1)", 4.1)
        sb.sleep(2)
